...
Voit antaa palautetta ja kehitysehdotuksia opintojaksosta kolmella tavalla:
 ...
 2. Mikäli havaitset materiaalissa virheen, epäselvyyden, tai muun ongelman, voit raportoida siitä
    GitHubissa klikkaamalla kunkin sivun alareunassa olevia linkkejä. Voit myös ilmoittaa puutteista suoraan opettajille sähköpostitse osoitteeseen `opet@TODO`.
...
Voit antaa palautetta myös perinteisesti sähköpostitse osoitteessa <opet@TODO>. Otamme mielellämme vastaan parannusehdotuksia! 
